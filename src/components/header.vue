<template>
  <div class="header">
      <div class="menu">
          <svg v-on:click="openMenu" v-if="mobile" width="20" height="14" xmlns="http://www.w3.org/2000/svg"><path d="M20 12v2H0v-2h20zm0-6v2H0V6h20zm0-6v2H0V0h20z" fill="#FFF" fill-rule="evenodd"/></svg>
          <div class="logo">
      ...
      <div class="image">
            <img v-bind:src="require('../assets/images/'+currentImage)" alt="home">
            <Switch v-if="mobile"></Switch>
      </div>
      <div v-if="menu" class="modal">
           <div v-on:click="closeMenu" class="overlay"></div>
           <div class="container">
               <div class="close">
                   <svg v-on:click="closeMenu" width="16" height="16" xmlns="http://www.w3.org/2000/svg"><path d="M14.364.222l1.414 1.414L9.414 8l6.364 6.364-1.414 1.414L8 9.414l-6.364 6.364-1.414-1.414L6.586 8 .222 1.636 1.636.222 8 6.586 14.364.222z" fill="#000" fill-rule="evenodd" opacity=".201"/></svg>
               </div>
               <div class="nav">
                   <ul>
                        <li>
...
export default {
    ...
    data(){
        return{
            menu:false,
            change:String,
            currentImage:'desktop-image-hero-1.jpg',
            image1:'desktop-image-hero-1.jpg',
            image2:'desktop-image-hero-2.jpg',
            image3:'desktop-image-hero-3.jpg',
        }
    },
    methods:{
        openMenu:function(){
        ...
        nextImage:function(){
            if(this.currentImage==this.image1 & this.change=='next'){
                this.currentImage=this.image2
            }
            else if(this.currentImage==this.image2 & this.change=='next'){
                this.currentImage=this.image3
            }
            else if(this.currentImage==this.image3 & this.change=='next'){
        ...
        previousImage:function(){
            ...
            else if(this.currentImage==this.image2){
                this.currentImage=this.image1
            }
            else if(this.currentImage==this.image3){
                this.currentImage=this.image2
            }
            else{
                this.currentImage=this.image1
...
<style src="../css/header.css" scoped>
</style>